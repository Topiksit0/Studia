                ...
                <div className='h-screen col-span-6'>
                    ...
                    <div className='h-[43rem] items-center sm:justify-start justify-center flex flex-wrap '>
                        <div className='sm:w-6/12'>
                            <h1 className='text-5xl tracking-tight font-semibold '>Welcome to the new era of Learning</h1>
                            <p className='pt-16'>Join the future of education with our user-friendly e-learning platform designed for the University of Barcelona.</p>
                        </div>

                        <div className='sm:ml-6 '>
                            <button class="relative inline-flex items-center justify-center p-1 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 
